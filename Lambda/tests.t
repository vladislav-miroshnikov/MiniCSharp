...
https://dune.readthedocs.io/en/stable/tests.html#cram-tests
  ...
  Evaluating: ((λ n -> ((n (λ x x y -> y)) ⊤)) (1 (2 (λ f x -> (f (f (f x)))))))
  Result:     ⊥
  ⊥
  ...
  Evaluating: (((λ f -> ((λ x -> (f (x x))) (λ x -> (f (x x))))) (λ self N -> ((((λ n -> ((n (λ x x y -> y)) ⊤)) N) 1) (((λ x y z -> (x (y z))) (self ((λ n f x -> (((n (λ g h -> (h (g f)))) (λ u -> x)) (λ u -> u))) N))) N)))) (((λ m n f x -> ((m f) ((n f) x))) 2) (λ f x -> (f (f (f x))))))
